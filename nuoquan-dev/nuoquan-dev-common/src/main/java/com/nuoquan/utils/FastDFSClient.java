...
//	}
	...
	public void deleteFile(String fileUrl) {
		...
		try {
			...
			System.out.print("解析StorePath文件路径对象错误:");
			e.getMessage();
		}
	}
	 ...
	 * @param gourp 组名
	 * 
	 * @Descprition 如果服务器上无该文件会报错，并停止运行下面代码
	 */
	public void deleteFile(String gourp,String fileUrl) {
		if (StringUtils.isEmpty(fileUrl)) {
			return;
		}
		try {
			storageClient.deleteFile(gourp, fileUrl);
		} catch (FdfsUnsupportStorePathException e) {
			System.out.print("解析StorePath文件路径对象错误:");
			e.getMessage();
		}
