	...
	<view class="message-list">
		<block v-for="(it,i) of messagesList" :key="i">
			...
			<view class="uni-swipe-action" style="height: 138upx;">
				<view class="delete-button super_center" v-if="showdelete == 1 && messageIndex == i">
				...
				box-shadow: 0upx 0upx 12upx 1upx #D1D1D1;"  @touchstart="touchStart" @touchmove="touchMove" @touchend="touchEnd"
				 @touchcancel="touchEnd" :style="{'transform':messageIndex == i ? transformX : 'translateX(0px)',
