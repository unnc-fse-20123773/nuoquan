<template>
	<view>
		<view style="margin-top: 14px;">
			...
			<!--标题-->
			<view selectable="true" class="detail-title" :style="{width : '100%'}">{{ articleCard.articleTitle }}</view>
		...
		<!--内容-->
		<view selectable="true" class="detailcontent">{{ articleCard.articleContent }}</view>
		<!--图片区域-->
		<view>
			<!-- 单图显示 -->
